...
public class CoilReceiveListActivity extends BaseActivity implements OnResponseFetchListener, ReceiptTranNoListAdapter.iTranNoListClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intializeXml();
        getRmCoilReceivingListData();
    }

    private void getRmCoilReceivingListData() {
...
//                CallService.getInstance().getResponseUsingPOST(CoilReceiveListActivity.this, Constants.RM_COIL_RECEIVE_TRAN_NO_LIST, param.toString(), CoilReceiveListActivity.this, Constants.RM_COIL_RECEIVE_LIST_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(CoilReceiveListActivity.this, mUserPref.getBASEUrl()+Constants.RM_COIL_RECEIVE_TRAN_NO_LIST, param.toString(), CoilReceiveListActivity.this, Constants.RM_COIL_RECEIVE_LIST_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(CoilReceiveListActivity.this, "Alert", "Please check your network connection");
            }
    ...
    private void intializeXml() {
        ...
        toolbar.setTitle(R.string.coil_receiving);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(CoilReceiveListActivity.this, Dashboard.class);
        startActivity(i);
    ...
    public void webserviceResponse(int request_id, String response) {
        if (request_id == Constants.RM_COIL_RECEIVE_LIST_REQ_ID) {
            ...
            if (response != null) {
                ...
                AlertDialogManager.getInstance().simpleAlert(CoilReceiveListActivity.this, "Alert", response.toString());
            }
        }
    }
    ...
    public void onTranNoListClick(int position) {
        if (mTranNoList != null && mTranNoList.size() > 0) {
            ...
            if (bean.getTranDate() != null && !bean.getTranDate().isEmpty() && !bean.getTranDate().equalsIgnoreCase("null")) {
                ...
                if (!tranDate.isEmpty()) {
                    Intent i = new Intent(CoilReceiveListActivity.this, CoilReceivingItemListActivity.class);
