...
//                CallService.getInstance().getResponseUsingPOST(NewPickupList.this, Constants.GET_PICKUP_LOCATION_VALIDATE, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_VALIDATE_LOCATION_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(NewPickupList.this,userPref.getBASEUrl()+ Constants.GET_PICKUP_LOCATION_VALIDATE, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_VALIDATE_LOCATION_REQ_ID, true);
            } else {
...
//                CallService.getInstance().getResponseUsingPOST(NewPickupList.this,  Constants.GET_PICKUP_LOCATIONS_ITEM, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_LOCATION_ITEM_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(NewPickupList.this, userPref.getBASEUrl()+Constants.GET_PICKUP_LOCATIONS_ITEM, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_LOCATION_ITEM_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(NewPickupList.this, "Alert", "No internet connection.");
            }
        } catch (Exception e) {
...
//                CallService.getInstance().getResponseUsingPOST(NewPickupList.this,  Constants.GET_PICKUP_SUMMARY, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_SUMMARY_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(NewPickupList.this, userPref.getBASEUrl()+Constants.GET_PICKUP_SUMMARY, jsonObjReqParam.toString(), NewPickupList.this, Constants.PICK_UP_SUMMARY_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(NewPickupList.this, "Alert", "No internet connection.");
            }
        } catch (Exception e) {
