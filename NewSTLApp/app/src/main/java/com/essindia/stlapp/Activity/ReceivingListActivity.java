...
public class ReceivingListActivity extends BaseActivity implements OnResponseFetchListener, ReceiptTranNoListAdapter.iTranNoListClick {
...
//                CallService.getInstance().getResponseUsingPOST(ReceivingListActivity.this, Constants.RM_RECEIPT_TRAN_NO_LIST, param.toString(), ReceivingListActivity.this, Constants.RM_RECEIPT_LIST_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(ReceivingListActivity.this,mUserPref.getBASEUrl()+ Constants.RM_RECEIPT_TRAN_NO_LIST, param.toString(), ReceivingListActivity.this, Constants.RM_RECEIPT_LIST_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(ReceivingListActivity.this, "Alert", "Please check your network connection");
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(ReceivingListActivity.this, Dashboard.class);
        startActivity(i);
    ...
    public void webserviceResponse(int request_id, String response) {
        if (request_id == Constants.RM_RECEIPT_LIST_REQ_ID) {
            if (response != null) {
                ...
                AlertDialogManager.getInstance().simpleAlert(ReceivingListActivity.this, "Alert", response.toString());
            }
        }
    }
    ...
    public void onTranNoListClick(int position) {
        ...
        if (bean.getTranDate() != null && !bean.getTranDate().isEmpty() && !bean.getTranDate().equalsIgnoreCase("null")) {
            ...
            if (!tranDate.isEmpty()) {
                Intent i = new Intent(ReceivingListActivity.this, ReceivingItemListActivity.class);
