...
import com.essindia.stlapp.Adapter.CoilReceiveDetailListAdapter;
...
public class CoilReceivingItemListActivity extends BaseActivity implements OnResponseFetchListener, BarcodeReader.BarcodeListener, BarcodeReader.TriggerListener, View.OnClickListener {
    ...
    private CoilReceiveDetailListAdapter adapter;
    ...
    private void intializeXml() {
        ...
        toolbar.setTitle(R.string.coil_receiving_item_list);
    ...
    private void getRmCoilReceiveItemListData() {
        ...
        if (mTranNo != null && mTranNo.length() > 0 && mTranDate != null && mTranDate.length() > 0) {
            mTvTranNo.setText("Tran No/Tran Date: " + mTranNo + " / " + mTranDate);
...
//                    CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_TRAN_DETAIL_LIST, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_LIST_DETAIL_REQ_ID, true);
                    CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this, mUserPref.getBASEUrl()+Constants.RM_COIL_RECEIVE_TRAN_DETAIL_LIST, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_LIST_DETAIL_REQ_ID, true);
                } else {
                    AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Please check your network connection");
                }
    ...
    private void spliteData(String data) {
        ...
        if (dataSp.length == 0) {
            AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Qr code is empty cannot load data item");
        } else if (dataSp.length < 9 || dataSp.length > 9) {
            AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Please enter correct format !");
    ...
    public void webserviceResponse(int request_id, String response) {
        if (response != null) {
            try {
                ...
                if (request_id == Constants.RM_COIL_RECEIVE_LIST_DETAIL_REQ_ID) {
                    if (statusCode.equalsIgnoreCase("0")) {
                        ...
                        if (array != null && array.length() > 0) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                bean.setMrsNo(obj.optString(ReqResParamKey.MRS_NO));
                                bean.setMrsDate(obj.optString(ReqResParamKey.MRS_DATE));
                            ...
                            adapter = new CoilReceiveDetailListAdapter(getApplicationContext(), mTranDetailList);
                ...
                } else if (request_id == Constants.RM_COIL_RECEIVE_SCAANED_ITEM_UPDATE_REQ_ID) {
                    mEtItemQrcode.setText("");
                    if (statusCode.equalsIgnoreCase("0")) {
                        showLongToast(message);
                        getRmCoilReceiveItemListData();
                    } else {
                        AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", message);
                    }
                } else if (request_id == Constants.RM_COIL_RECEIVE_LIST_SUBMIT_REQ_ID) {
                    if (statusCode.equalsIgnoreCase("0")) {
            ...
            AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Server not responding.");
        }
    }

    private void goBackTranListScreen() {
        Intent i = new Intent(CoilReceivingItemListActivity.this, CoilReceiveListActivity.class);
        startActivity(i);
...
//                confirmAlert("All Record is not submit!", "Do you want to proceed without submit the record");
    ...
    private void callItemScanSubmitApi(String qrCOdeData) {
        try {
            ...
            param.put(ReqResParamKey.VC_USER_CODE, mUserPref.getUserName());
            if (mConnectionDetector.isConnectingToInternet()) {
//                CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_UPDATESCANNED_ITEM, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_SCAANED_ITEM_UPDATE_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this, mUserPref.getBASEUrl()+Constants.RM_COIL_RECEIVE_UPDATESCANNED_ITEM, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_SCAANED_ITEM_UPDATE_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Please check your network connection");
            }
        } catch (JSONException e) {
    ...
    private void callListItemSubmitApi() {
        try {
            ...
            param.put(ReqResParamKey.VC_USER_CODE, mUserPref.getUserName());
            if (mConnectionDetector.isConnectingToInternet()) {
//                CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_SUBMIT_ITEM_LIST, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_LIST_SUBMIT_REQ_ID, true);
                CallService.getInstance().getResponseUsingPOST(CoilReceivingItemListActivity.this,mUserPref.getBASEUrl()+ Constants.RM_COIL_RECEIVE_SUBMIT_ITEM_LIST, param.toString(), CoilReceivingItemListActivity.this, Constants.RM_COIL_RECEIVE_LIST_SUBMIT_REQ_ID, true);
            } else {
                AlertDialogManager.getInstance().simpleAlert(CoilReceivingItemListActivity.this, "Alert", "Please check your network connection");
            }
        } catch (JSONException e) {
